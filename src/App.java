...
import Estructures.Ejercicios;
import Estructures.Maps;
import Estructures.Sets;
...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        //Maps mapsClase = new Maps();
        //System.out.println("HashMap");
        //Map<String, Integer> hashMap = mapsClase.construirHashMap();
        //System.out.println(hashMap);

        //System.out.println("LinkedHashMap");
        //Map<String, Integer> linkedHashMap = mapsClase.contruirlinkedHashMap();
       // System.out.println(linkedHashMap);

        //System.out.println("TreeMap");
        //Map<String, Integer> treeMap = mapsClase.contruirTreeMap();
       // System.out.println(treeMap);

       // Map<Person, Integer> personTreeMap = mapsClase.contruirtreeMap();
        //System.out.println(personTreeMap);

        //mapsClase.printFilter(personTreeMap);

        // mapsClase.contruirTreeMapPersonObj();
        // System.out.println(mapsClase.contruirTreeMapPersonObj());
    ...
    // Set<String> linkSet = setsClase.construLinkedHashSet();
    ...
    // Set<String> treeSetConComparador = setsClase.contruirTreeSerConComparador();
    // System.out.println(treeSetConComparador);


    // Set<Person> personsTreeSet = setsClase.personsTreeSet();
    ...
    //     List<Maquina> crearMaquinas = crearMaquinas();
    //     MaquinaController controller = new MaquinaController();
    //     Set<Maquina> maquinasOrdenadas = controller.ordenarPorSubred(crearMaquinas);
    //     for(Maquina maquina : maquinasOrdenadas){
    //         System.out.println(maquina);
    //     }
    //     System.out.println( maquinasOrdenadas.size());

        
    // }
    // public static List<Maquina> crearMaquinas() {
    ...
    public static void runEjercicios(){
        ...
        List<Integer> list2 = Arrays.asList(4, 5, 1, 2, 5, 4, 3, 2, 1, 6,7, 3, 8, 9, 6, 7, 10);
        Integer primerNoRepetido = ejercicios.primerNoRepetido(list2);
        System.out.print("El primer numero no repetido es: " + primerNoRepetido);



        // Map<String, Integer> jugadorese = new HashMap<>();
        ...
        List<String[]> jugadores = Arrays.asList(
    new String[]{"Ana", "80"},
    new String[]{"Luis", "90"},
    ...
    new String[]{"Maria", "75"}
        ...
        Map<String, Integer> ranking = ejercicios.RankingPuntajes(jugadores);
        System.out.println("\nRanking de puntajes:");
